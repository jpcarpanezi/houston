namespace Houston.Core.Models.GitHub.Push {
	public class Commit {
		...
		[JsonConstructor]
		public Commit(string id, string treeId, bool distinct, string message, DateTime timestamp, string url, Author author, Committer committer, List<string> added, List<string> removed, List<string> modified) {
