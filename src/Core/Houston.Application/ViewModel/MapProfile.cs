namespace Houston.Application.ViewModel {
	public class MapProfile : Profile {
		public MapProfile() {
			...
			CreateMap<ConnectorFunctionHistory, ConnectorFunctionHistoryDetailViewModel>()
				.ForMember(dest => dest.CreatedBy, m => m.MapFrom(src => src.CreatedByNavigation.Name))
				.ForMember(dest => dest.UpdatedBy, m => m.MapFrom(src => src.UpdatedByNavigation.Name));

			CreateMap<ConnectorFunctionHistory, ConnectorFunctionHistorySummaryViewModel>()
				.ForMember(dest => dest.CreatedBy, m => m.MapFrom(src => src.CreatedByNavigation.Name))
				.ForMember(dest => dest.UpdatedBy, m => m.MapFrom(src => src.UpdatedByNavigation.Name));
			...
			CreateMap<PipelineLog, PipelineLogViewModel>()
				...
				.ForMember(dest => dest.InstructionWithError, m => m.MapFrom(src => src.PipelineInstruction!.ConnectorFunctionHistory.ConnectorFunction.Name))
