...
import { faArrowLeft, faArrowRight, faBars, faBell, faChevronDown, faChevronUp, faCircleCheck, faCircleXmark, faFileImport, faFileLines, faFloppyDisk, faGear, faHouse, faMagnifyingGlass, faMinus, faPencil, faPlay, faPlus, faPuzzlePiece, faRightToBracket, faRotate, faStopwatch, faTableList, faToggleOff, faToggleOn, faTrash, faUsers, faWrench, faXmark } from '@fortawesome/free-solid-svg-icons';
